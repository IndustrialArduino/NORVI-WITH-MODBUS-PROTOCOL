 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font G:/Shared drives/Product Support Resources/NORVI ESP HMI/SQUARE_OUTPUT/assets/arial.ttf -o G:/Shared drives/Product Support Resources/NORVI ESP HMI/SQUARE_OUTPUT/assets\ui_font_arial16.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/
